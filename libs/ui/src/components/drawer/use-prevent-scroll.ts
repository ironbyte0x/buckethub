...
function preventScrollStandard() {
  ...
  return chain(
    ...
    setStyle(document.documentElement, 'overflow', 'hidden !important')
  );
}
...
function setStyle(element: HTMLElement, style: keyof CSSStyleDeclaration, value: string) {
  const current = element.style[style];
...
function addEvent<K extends keyof GlobalEventHandlersEventMap>(
  ...
  event: K,
  handler: (this: Document | Window, event_: GlobalEventHandlersEventMap[K]) => void,
